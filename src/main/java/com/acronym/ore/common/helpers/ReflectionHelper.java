...
public class ReflectionHelper {
    ...
    public static Constructor<?> getConstructor(final String className, final Class<?>... argumentTypes) {
        if (className == null || argumentTypes == null) {
            System.out.println("The provided class name or arguments can't be null.");
            return null;
        }
    ...
    public static <T> T getObject(Object object, String... fieldNames) {
        ...
        System.out.println("Could not retrieve any object for the provided field names.");
    ...
    public static <T> T getFinalObject(Object object, String... fieldNames) {
        ...
        System.out.println("Could not retrieve any final object for the provided field names.");
    ...
    public static <T> T getStaticObject(Class<?> clazz, String... fieldNames) {
        ...
        System.out.println("Could not retrieve any static object for the provided field names.");
