...
public class WorldGenOreMinable extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        double d2 = (double)((float)(position.getZ() + 8) + MathHelper.sin(f) * (float)this.numberOfBlocks / 8.0F);
        ...
        for (int i = 0; i < this.numberOfBlocks; ++i) {
            ...
            double d10 = (double)(MathHelper.cos((float)Math.PI * f1) + 1.0F) * d9 + 1.0D;
            double d11 = (double)(MathHelper.cos((float)Math.PI * f1) + 1.0F) * d9 + 1.0D;
